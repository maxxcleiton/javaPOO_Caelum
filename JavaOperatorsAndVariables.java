class JavaOperatorsAndVariables{
    ...
    args) {
        ...
        int marchCost = 17000;
        int quarterYearCost;
        int monthlyCostAverage;

        // Despesa total no trimestre:
        quarterYearCost = januaryCost + februaryCost + marchCost;

        // Média mensal de gastos:
        monthlyCostAverage = quarterYearCost/3;

        // Impressão:
        System.out.println("Quarter Year Total Cost: " + quarterYearCost);
        System.out.println("Month's Cost Median: " + monthlyCostAverage);
